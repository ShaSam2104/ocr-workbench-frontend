...
class _EditChapterDialogState extends State<EditChapterDialog> {
  ...
  Future<void> _updateChapter() async {
    ...
    try {
      ...
      final result = await OCRWorkbenchAPIGroup.updateChapterCall.call(
      ...
      if (result.succeeded) {
        ...
        setState(() {
          _errorMessage = result.exception != null
              ...
              : 'Failed to update chapter (Status: ${result.statusCode})';
          _isLoading = false;
        });
      }
    } catch (e) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        onFieldSubmitted: (_) => _updateChapter(),
                        validator: (value) {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _isLoading ? null : _updateChapter,
