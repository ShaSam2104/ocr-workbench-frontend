...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    ocrWorkbenchAuthUserSubject.add(
      OcrWorkbenchAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<OcrWorkbenchAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  OcrWorkbenchAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = OcrWorkbenchAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    ocrWorkbenchAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
OcrWorkbenchAuthUser? currentUser;
